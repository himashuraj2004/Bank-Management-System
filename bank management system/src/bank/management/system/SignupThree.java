...
public class SignupThree extends JFrame implements ActionListener{
    ...
    String formno;
        ...
        SignupThree(String formno){
            ...
            this.pack(); // Important for scroll pane to take effect
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == submit){
            ...
            if(r2.isSelected()) accountType = "Fixed Account";
            if(r3.isSelected()) accountType = "Current Account";
            if(r4.isSelected()) accountType = "Recurring Deposit Account";
            ...
            if(c4.isSelected()) facility = facility + "Email & SMS Alerts";
            ...
            try{
                ...
                else if(!c7.isSelected()) JOptionPane.showMessageDialog(null, "You need to declare the pledge");
                else{
                    Conn conn = new Conn();
